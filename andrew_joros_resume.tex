...
%-----------SUMMARY-----------
\section{Summary}
Research computing engineer who builds production-grade data and analytics systems from ingestion to decision-ready delivery. I develop reproducible pipelines, APIs, and interactive applications that turn complex datasets into reliable, actionable insights for technical and non-technical stakeholders.
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Contributed to predictive analytics by validating clustering outputs and automating preprocessing}
        \resumeItem{Built OpenFOAM post-processing pipeline for snow-transport datasets and wall-shear diagnostics}
        \resumeItem{Operated automated snow-drought pipeline producing HUC and station classification graphics}
        \resumeItem{Developed internal DRI-hosted Flask/xarray web app for county climate-risk maps}
        \resumeItem{Automated Nevada groundwater and projected pumpage reporting across 262 hydrographic basins}
        \resumeItem{Built public snowpack-runoff decision tool using Leaflet/Plotly and SNOTEL ingestion}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed an AWS front-end webpage delivering Interagency Wildland Fire Air Quality statistical outputs}
      \resumeItemListEnd
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Developed groundwater survey software using vertical electrical sounding to improve well siting and drilling}
        \resumeItem{Contributed to meteorological and air pollutant data pipelines supporting Healthy Nevada Project research}
        \resumeItem{Integrated Christopher Ranch's sensor data into AWS for storage and machine learning use}
        \resumeItem{Built AWS EC2 probabilistic insect and disease models for pest management and crop protection}
    ...
    \resumeSubheading
      ...
      {Applied Innovation Center, Desert Research Institute}{Reno, NV}
      \resumeItemListStart
        \resumeItem{Constructed backend data architecture for WINDS, improving weather processing and decision support}
        \resumeItem{Developed a web portal for NDOT, enabling traffic-data analysis for transportation planning}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Contributed to Climate and Integrated Earth Monitoring Engine dashboard, improving data visualization}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Conducted statistical QA/QC of SODAR output data to ensure reliability}
      \resumeItemListEnd
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Programming Languages}{: Python, MATLAB, R, JavaScript, SQL} \\
     \textbf{Data \& Scientific Computing}{: xarray, pandas, NumPy, NetCDF, Parquet, JSON} \\
     \textbf{Modeling \& Visualization}{: OpenFOAM, ParaView, PyVista, Matplotlib, Plotly, ArcGIS} \\
     \textbf{Web \& APIs}{: Flask, Django, Leaflet, HTML5, CSS, REST APIs} \\
     \textbf{Cloud \& DevOps}{: Amazon Web Services, Google Cloud Platform, Azure, Git, GitHub Actions} \\
...
\section{Publications and Reports}
 \begin{enumerate}[leftmargin=0.25in, label=\arabic*.]
    \small{\item Yu, G., Miller, J. J., Mejia, J. F., Rasouli, K., McCarthy, M. I., Joros, A. N., O'Shea, K. (2026). Updating the Probable Maximum Precipitation for Nevada. Damon, N. E. (ed.), Division of Hydrologic Sciences, Desert Research Institute: Nevada Division of Water Resources, June 30, 2025, DHS publication \#41312.}
    \item Luo, S., Jiang, R., Grzymski, J.J., Lee, W., \& Joros, A. (2021). Comprehensive allele genotyping in critical pharmacogenes reduces residual clinical risk in diverse populations. Clinical Pharmacology \& Therapeutics, 110(4), 899–911.
    \item Kiser, D., Metcalf, W.J., Elhanan, G., Schnieder, B., Schlauch, K., Joros, A., Petersen, C. and Grzymski, J., 2020. Particulate matter and emergency visits for asthma: a time-series study of their association in the presence and absence of wildfire smoke in Reno, Nevada, 2013–2018. Environmental Health, 19(1), pp.1-12.
    \item Nauslar, N.J., Hatchett, B.J., Brown, T.J., \& Joros, A. (2019). Impact of the North American monsoon on wildfire activity in the southwest United States. International Journal of Climatology, 39(4), 1861–1879.
    \item Abatzoglou, J.T., McEvoy, D.J., Joros, A., et al. (2017). The West Wide Drought Tracker: Drought Monitoring at Fine Spatial Scales. Bulletin of the American Meteorological Society, 98(9), 1815–1820.
    ...
    \item Morton, C. G., Huntington, J. L., Allen, R. G., Kilic, A., Joros, A. N. (2015). More Landsat Satellites Equates to More Reliable Monitoring of Water Consumption. Remote Sensing.
...
\section{Conference Papers/Presentations}
 \begin{enumerate}[leftmargin=0.25in, label=\arabic*.]
    \small{\item Saftner, D. M., Arienzo, M. M., Atkin, J., Daniel, A. T., Dunkerly, C. W., Gordon, B., Greene, S. J., Huntington, J. L., Joros, A. N., Kozloski, R., Lutz, A. D., Parker, B. A., ReVelle, P., VanderMolen, K.A. (2026). Developing Water Resource Plans for Rural Nevada. Nevada Tribal Food and Agriculture Summit: Sparks, NV, March 24--27, 2026.}
    ...
    \item McEvoy, D. J., Rhoades, A., Huning, L., Heggli, A. E., Hatchett, B., Joros, A. N. (2025). Storm-scale impacts on seasonal snow droughts: A case study in the Pacific Northwest, United States. International Mountain Conference poster: Innsbruck, Austria, September 14--18, 2025.
    ...
    \item Rowan, C., Metcalf, W. J., Elhanan, G., Joros, A. N., \& Grzymski, J. J. (2018). Short-Term Sentinel Air Events in Relation to Health Care Utilization for Specific Health Conditions in Reno, Nevada. In B24. AN UPDATE ON INDOOR AND OUTDOOR AIR POLLUTION (pp. A2815-A2815). American Thoracic Society.
    ...
    \item Huntington, J. L., Morton, C. G., McGwire, K. C., Allen, R., Gorelick, N., Thau, D., Joros, A. N. (2014). Monitoring Groundwater Dependent Ecosystems in the Great Basin from Space and Clouds, American Water Resources Association Summer Specialty Conference: Reno, NV, May 31, 2014-July 2, 2014
