...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Contributed to predictive analytics workflows by testing model consistency, evaluating clustering strategies, and automating preprocessing for reliable downstream analysis}
        \resumeItem{Built an OpenFOAM post-processing pipeline that converts large CFD snow-transport outputs into analysis-ready datasets and wall-shear-stress diagnostics}
        \resumeItem{Operate an automated snow-drought dashboard pipeline that ingests SNOTEL data and generates HUC-level and station-level drought classification graphics}
        \resumeItem{Developed a Flask/xarray climate-risk API and interactive web maps serving long-horizon county heat and energy indicators}
        \resumeItem{Automated Nevada groundwater-use and projected pumpage reporting across 262 hydrographic basins to support county water-planning deliverables}
        \resumeItem{Architected a public snowpack-runoff decision-support tool combining a Leaflet/Plotly web interface with automated SNOTEL/CDEC ingestion and JSON processing pipelines to deliver faster, clearer real-time watershed conditions}
      \resumeItemListEnd
